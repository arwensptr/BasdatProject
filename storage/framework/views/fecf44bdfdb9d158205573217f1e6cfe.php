     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                <form action="<?php echo e(route('admin.analytics.sales')); ?>" method="GET" class="flex flex-wrap items-center gap-2">
                    ...
                    <?php if(request('bulan') || request('quarter')): ?>
                        <a href="<?php echo e(route('admin.analytics.sales')); ?>" class="h-10 px-4 inline-flex items-center gap-2 bg-red-50 dark:bg-red-900/20 text-red-600 rounded-xl text-sm font-medium hover:bg-red-100">Reset</a>
                    <?php endif; ?>
                </form>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-slate-600 dark:text-slate-400">
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                                <?php $__empty_1 = true; $__currentLoopData = $topCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cust): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                                        <td class="px-6 py-4 font-medium text-slate-900 dark:text-white"><?php echo e($cust->name); ?></td>
                                        <td class="px-6 py-4 text-center"><?php echo e($cust->total_trx); ?>x</td>
                                        <td class="px-6 py-4 text-right font-bold text-emerald-600">Rp <?php echo e(number_format($cust->total_spend, 0, ',', '.')); ?></td>
                                    </tr>
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                                <?php $__empty_1 = true; $__currentLoopData = $topCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                                        ...
                                        <td class="px-6 py-4 text-center"><?php echo e($cat->total_qty); ?></td>
            ...
            <div class="card p-0 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm rounded-2xl overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-slate-600 dark:text-slate-400">
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                            <?php $__empty_1 = true; $__currentLoopData = $monthlyRecap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                                    <td class="px-6 py-4 font-medium text-slate-900 dark:text-white"><?php echo e($row->nama_bulan); ?></td>
                                    <td class="px-6 py-4 text-center">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                            <?php echo e($row->total_trx); ?> Order
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-right font-bold text-slate-800 dark:text-white">Rp <?php echo e(number_format($row->total_revenue, 0, ',', '.')); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr><td colspan="3" class="px-6 py-4 text-center">Tidak ada data</td></tr>
                            <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\farmacheat\resources\views/admin/analytics/sales.blade.php ENDPATH**/ ?>