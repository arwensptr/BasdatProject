...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-slate-200">Upload Bukti Pembayaran — Pesanan #<?php echo e($order->id); ?></h2>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-slate-800 shadow-lg rounded-lg">
                <form method="POST" action="<?php echo e(route('shop.payments.store',$order)); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="p-8">
                        <div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\farmacheat\resources\views/shop/payments/create.blade.php ENDPATH**/ ?>