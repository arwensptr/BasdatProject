...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-display text-2xl text-brand-800 dark:text-brand-300">Review Resep</h2>
     <?php $__env->endSlot(); ?>
        ...
        <div class="section">
            ...
            <div class="grid sm:grid-cols-3 gap-4">
                <div class="card pad">
                    ...
                    <div class="text-3xl font-bold dark:text-white"><?php echo e(method_exists($pending,'total') ? $pending->total() : $pending->count()); ?></div>
                </div>
                <div class="card pad">
                    <div class="text-sm text-gray-500 dark:text-slate-400">Resep Disetujui</div>
                    <div class="text-3xl font-bold dark:text-white"><?php echo e(isset($approved) && method_exists($approved,'total') ? $approved->total() : ($approved->count() ?? 0)); ?></div>
                </div>
                <div class="card pad">
                    <div class="text-sm text-gray-500 dark:text-slate-400">Resep Ditolak</div>
                    <div class="text-3xl font-bold dark:text-white"><?php echo e(isset($rejected) && method_exists($rejected,'total') ? $rejected->total() : ($rejected->count() ?? 0)); ?></div>
                </div>
            </div>

            <div class="card pad">
                <div class="font-semibold text-lg mb-4 dark:text-white">Daftar Resep Menunggu</div>
...
<?php endif; ?></td>
                                    <td class="px-4 py-3">
                                        <a class="btn btn-primary px-3 py-1" href="<?php echo e(route('admin.prescriptions.show',$p)); ?>">Lihat</a>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr><td colspan="5" class="py-6 text-center text-gray-500 dark:text-slate-400">Tidak ada resep menunggu.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\farmacheat\resources\views/admin/prescriptions/index.blade.php ENDPATH**/ ?>